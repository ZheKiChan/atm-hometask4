...
describe('My Test', () => {
    ...
    before(() => {
        ...
        it('should have military Planes with transport type', () => {
            ...
            assert.include(transportMilitaryPlanes, MilitaryType.TYPE_TRANSPORT);
        });
        ...
        it('should check that next plane max load capacity is higher than current', () => {
            let planesSortedByMaxLoadCapacity = airport.sortByMaxLoadCapacity();
            assert.isTrue(planesSortedByMaxLoadCapacity);
        })

        it('should have at least one Bomber in military planes', () => {
            let bomberMilitaryPlanes = airport.getBomberMilitaryPlanes();
            assert.include(bomberMilitaryPlanes, MilitaryType.BOMBER);
        })
        ...
        it('should check that experimentsl planes has classification level higher than unclassified', () => {
            ...
            assert.notInclude(experimentalPlanes, ClassificationLevel.UNCLASSIFIED);
        });
    })
});