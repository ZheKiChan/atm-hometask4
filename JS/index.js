...
(function run() {
    ...
    console.log(`Military airport sorted by max distance: ${militaryAirport.sortByMaxDistance()}`);
    console.log(`Passenger airport sorted by max speed: ${passengerAirport.sortByMaxSpeed()}`);
    console.log(`Plane with max passenger capacity: ${passengerAirport.getPassengerPlaneWithMaxPassengersCapacity()}`);
})();